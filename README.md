...
- **Jump and double jump behaviour**
- **Directional projectile input**
...
- **Arrow Keys / Movement Input** — Move character
- **Left Shift** — Run
- **Space** — Jump / Double Jump
- **C** — Throw spear
- **Up Arrow** — Vertical spear direction
- **F1** — Switch between 2D and 3D movement
